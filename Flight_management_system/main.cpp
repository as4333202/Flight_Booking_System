...
public://public member functions
    ...
    cin >> doj;
    cout << "\1.Lahore(1) \t\2.Karachi(2) \t\3.Islamabad(3) \t\4.Peshawar(4)" << endl << endl;
    ...
    cout << "\1.Fly Jinnah(1)\t08:00\t\t11:05\t\tRs.5000\t\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t17:05\t\tRs.5500\t\tRefundable\n";
    ...
    cout << "\t \t \tFlights Found" << endl << endl;
    cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
    cout << "\1.Fly Jinnah(1)\t08:00\t\t11:05\t\tRs.4000\t\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t17:05\t\tRs.4250\t\tRefundable\n";
    ...
    cout << "\t \t \tFlights Found" << endl << endl;
    cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
    cout << "\1.Fly Jinnah(1)\t08:00\t\t11:05\t\tRs.5400\t\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t17:05\t\tRs.2500\t\tRefundable\n";
    ...
    cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
    cout << "\1.Fly Jinnah(1)\t08:00\t\t11:05\t\tRs.5000\t\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t17:05\t\tRs.4500\t\tRefundable\n";
    cout << "\3.Go Air(3)\t19:00\t\t22:05\t\tRs.6000\t\tRefundable\n";
    }
    else if((src==3 && dest==4) || (src==4 && dest==3))//condition
   {
    cout << "\t \t \tFlights Found" << endl << endl;
    cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
    cout << "\1.Fly Jinnah(1)\t08:00\t\t11:05\t\tRs.5800\t\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t17:05\t\tRs.5508\t\tRefundable\n";
    ...
    cout << "Fly Jinnah"<<endl;
    strcpy(f_d,"Fly Jinnah");//copy to string
...
protected://protected members
    ...
    long int doji;//date of journey international
...
public://public member functions
    ...
    {
    cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
    cout << "\1.Fly Jinnah(1)\t10:00\t\t14:05\t\tRs.25000\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t18:05\t\tRs.21500\tRefundable\n";
    ...
    {
    cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
    cout << "\1.Fly Jinnah(1)\t10:00\t\t14:05\t\tRs.25500\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t18:05\t\tRs.21300\tRefundable\n";
    ...
    {
    cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
    cout << "\1.Fly Jinnah(1)\t10:00\t\t14:05\t\tRs.52500\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t18:05\t\tRs.59420\tRefundable\n";
    ...
    {
    cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
    cout << "\1.Fly Jinnah(1)\t10:00\t\t14:05\t\tRs.17800\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t18:05\t\tRs.14900\tRefundable\n";
    ...
    {
    cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
    cout << "\1.Fly Jinnah(1)\t10:00\t\t14:05\t\tRs.32000\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t18:05\t\tRs.38500\tRefundable\n";
    cout << "\3.Emirates(3)\t18:00\t\t22:05\t\tRs41259\tRefundable\n";    }

    else if(srci==2 && desti==5 || (srci==5 && desti==2))//condition
    {
    cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
    cout << "\1.Fly Jinnah(1)\t10:00\t\t14:05\t\tRs.82500\tRefundable\n";
    cout << "\2.PIA(2)   \t14:00\t\t18:05\t\tRs.87550\tRefundable\n";
    ...
    cout << "\nFlight selected:" <<endl;
    cout << "Fly Jinnah" << endl;
    strcpy(f_i,"Fly Jinnah");//copy to string
...
public://public member functions
    ...
    { j_detail();//function call for domestic flight
    select_flight();//function call
    }
        else
    {  j_detaili();//function call for international Flight
   select_flighti();//function call
    ...
    void gender_check()//to check gender input as valid
    {
    cout << "\nGender:\nPress 1 for Male and Press 2 for Female::";
    cin >> gender;
...
int main()
{
   ...
   break;
    case 4:
			cout<<"\n\n\t\t\tThank you so much for our Flight Reservation System";
			return 0;
